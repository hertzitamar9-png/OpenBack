...
export const translateText = (
  ...
  if (
    ...
    return applyOpenBackBrand(key, message);
  }
  ...
  try {
    ...
    return applyOpenBackBrand(key, formatter.format(resolvedParams) as string);
  } catch (e) {
...
export function getMessageTypeClasses(type: MessageType): string {
  switch (type) {
    ...
    case MessageType.ENCIRCLEMENT_STARTED:
    case MessageType.WAR_EXHAUSTION:
