...
export class MainLayout extends LitElement {
  ...
  render() {
    return html`
      ...
      >
        <div
          class="w-full lg:max-w-[20cm] 2xl:max-w-[24cm] mx-auto flex flex-col flex-1 min-h-0 gap-0 lg:gap-[clamp(1.5rem,3vw,3rem)] overflow-y-auto overflow-x-hidden overscroll-y-contain sm:px-4 lg:px-0"
        >
