...
export interface UnitParamsMap {
  ...
  [UnitType.TankMine]: Record<string, never>;
  [UnitType.Plane]: {
    troops?: number;
    targetTile?: TileRef;
    trajectory: TrajectoryTile[];
...
export const MESSAGE_TYPE_CATEGORIES: Record<MessageType, MessageCategory> = {
  [MessageType.ATTACK_FAILED]: MessageCategory.COMBAT,
  [MessageType.ATTACK_CANCELLED]: MessageCategory.COMBAT,
  [MessageType.ATTACK_REQUEST]: MessageCategory.COMBAT,
  [MessageType.CONQUERED_PLAYER]: MessageCategory.COMBAT,
  ...
  [MessageType.NAVAL_INVASION_INBOUND]: MessageCategory.COMBAT,
  [MessageType.SAM_MISS]: MessageCategory.COMBAT,
  [MessageType.SAM_HIT]: MessageCategory.COMBAT,
  [MessageType.CAPTURED_ENEMY_UNIT]: MessageCategory.COMBAT,
  [MessageType.UNIT_DESTROYED]: MessageCategory.COMBAT,
  ...
  [MessageType.ENCIRCLEMENT_STARTED]: MessageCategory.COMBAT,
  [MessageType.WAR_EXHAUSTION]: MessageCategory.COMBAT,
