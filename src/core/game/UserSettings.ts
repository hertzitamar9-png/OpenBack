...
export function getDefaultKeybinds(isMac: boolean): Record<string, string> {
  return {
    ...
    buildMIRV: "Digit0",
    buildPlane: "Shift+Digit1",
    buildManpad: "Shift+Digit2",
    buildRunway: "Shift+Digit3",
    buildMilitaryBase: "Shift+Digit4",
    buildTank: "Shift+Digit5",
    buildTankMine: "Shift+Digit6",
...
export class UserSettings {
  ...
  backgroundMusicVolume(): number {
    return this.getFloat("settings.backgroundMusicVolume", 0.32);
  }
  ...
  soundEffectsVolume(): number {
    return this.getFloat("settings.soundEffectsVolume", 0.6);
  }
