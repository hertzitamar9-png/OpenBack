## OpenBack v0.35.173 - Caught Up With OpenFront
...
## OpenBack v0.35.172 - Said Once

- Stopped the login code email repeating itself in the inbox preview.

Created by **frootz jhklphy**.

## OpenBack v0.35.171 - The Code Comes First
...
## OpenBack v0.35.170 - Where To Reach Us

- Pointed the Service Request link in the menu at the new OpenBack contact address.

Created by **frootz jhklphy**.

## OpenBack v0.35.169 - The Code Before You Open It
...
## OpenBack v0.35.168 - The Logo Travels With The Email
...
## OpenBack v0.35.167 - Log In Means Log In
...
## OpenBack v0.35.166 - Knowing The Code Was Sent
...
## OpenBack v0.35.165 - A Cleaner Code
...
## OpenBack v0.35.164 - Names For The New Maps
...
## OpenBack v0.35.163 - A Readable Login Code
...
## OpenBack v0.35.162 - One Match Per Account
...
## OpenBack v0.35.161 - Light On The Whole Sea
...
## OpenBack v0.35.160 - A Matching Pair
...
## OpenBack v0.35.159 - Finishing On Time
...
## OpenBack v0.35.158 - A Quieter Footer
...
## OpenBack v0.35.157 - One Shared Minute For Everyone
...
## OpenBack v0.35.156 - Big Seas, Clean Oceans
...
## OpenBack v0.35.155 - The Updating Screen Reaches Everyone
...
## OpenBack v0.35.154 - Back No Longer Abandons Your Match
...
## OpenBack v0.35.153 - Water That Catches The Light
...
## OpenBack v0.35.152 - Real Moving Sea, No More Dark Patches
...
## OpenBack v0.35.151 - Waves You Can Actually See
...
## OpenBack v0.35.150 - Leaving Always Asks, Even While Loading
...
## OpenBack v0.35.149 - Sun, Moon And A Sky Worth Looking At
...
## OpenBack v0.35.148 - The Night Tide Takes Ground
...
## OpenBack v0.35.147 - Living Water Across Every Ocean
...
## OpenBack v0.35.146 - Leaving A Match Asks First
...
## OpenBack v0.35.145 - Cleared Out The Old Host
...
## OpenBack v0.35.144 - Licence Notices Reach The Screen
...
## OpenBack v0.35.143 - Complete Licence Notices
...
## OpenBack v0.35.142 - Phone Controls Sized For Fingers
...
## OpenBack v0.35.141 - Back Steps Out One Level
...
## OpenBack v0.35.140 - Menu Everywhere and Chosen Frame Rate
...
## OpenBack v0.35.139 - Restored Classic Battlefield Art
...
## OpenBack v0.35.138 - Restored Living Seas
...
## OpenBack v0.35.137 - Ready Fleet and Living Seas
...
## OpenBack v0.35.136 - Touch-Safe Landscape Command
...
## OpenBack v0.35.135 - Complete Mobile Command Screen
...
## OpenBack v0.35.134 - Mobile Battlefield HUD
...
## OpenBack v0.35.133 - Clean Mobile Building
...
## OpenBack v0.35.132 - Visible Battlefield Models
...
## OpenBack v0.35.131 - Raised Seas and Reliable Deployments
...
## OpenBack v0.35.130 - Stable 3D Operations
...
## OpenBack v0.35.129 - Clear Country Labels
...
## OpenBack v0.35.128 - Organized 3D Rail and Air Operations
...
## OpenBack v0.35.127 - Classic Models and Living 3D Seas
...
## OpenBack v0.35.126 - Living War Table
...
## OpenBack v0.35.125 - Accurate Nuclear Targeting
...
## OpenBack v0.35.124 - OpenFront v0.33.4 and Tactical Clarity
...
## OpenBack v0.35.123 - Complete 3D Battlefield Visibility
...
## OpenBack v0.35.122 - Parked Vehicle Readiness and Tank Defenses
...
## OpenBack v0.35.121 - Stable World Matches and Restored Build Shortcuts
...
## OpenBack v0.35.120 - Reliable In-Flight Bomb Targets
...
## OpenBack v0.35.119 - Restored OpenFront Bomb Flight Preview
...
## OpenBack v0.35.118 - Restored OpenFront Bomb Targets
...
## OpenBack v0.35.117 - Classic Units in 3D
...
## OpenBack v0.35.116 - Living 3D Battlefield
...
## OpenBack v0.35.115 - Clear 2D Bomb Targets
...
## OpenBack v0.35.114 - Restored Bomb Destinations
...
## OpenBack v0.35.113 - Stable Railroad Rendering
...
## OpenBack v0.35.112 - Complete Visible Features
...
## OpenBack v0.35.111 - Complete Tribe Service
...
## OpenBack v0.35.110 - Native OpenBack Dialogs
...
## OpenBack v0.35.109 - Stable Nuclear Warnings
...
## OpenBack v0.35.108 - Complete Battle Artwork
...
## OpenBack v0.35.107 - Complete 3D Battlefield Parity
...
## OpenBack v0.35.106 - Clean Profile Identity
...
## OpenBack v0.35.105 - Reliable Social Connection
...
## OpenBack v0.35.104 - Stable 3D Battlefield
...
## OpenBack v0.35.103 - Clean Home Selectors
...
## OpenBack v0.35.102 - Real 3D Battlefield Models
...
## OpenBack v0.35.101 - Visible 3D Construction
...
## OpenBack v0.35.100 - Precise 3D Control and Territory Locator
...
## OpenBack v0.35.99 - Tabletop Camera Foundation
...
## OpenBack v0.35.98 - Persistent Player Identity
...
## OpenBack v0.35.97 - Accurate Profile Status
...
## OpenBack v0.35.96 - Continuous 3D Zoom
...
## OpenBack v0.35.95 - Stable 3D Zoom
...
## OpenBack v0.35.94 - Clearer 3D Battlefield
...
## OpenBack v0.35.93 - Distinct Store Collection
...
## OpenBack v0.35.92 - Complete Ranked and Distinct Cosmetics
...
## OpenBack v0.35.91 - Clean Production Matches
...
## OpenBack v0.35.90 - Reliable Artwork
...
## OpenBack v0.35.89 - Clean Fast Mobile
...
## OpenBack v0.35.88 - Mobile Everywhere
...
## OpenBack v0.35.87 - Clean Mobile Home
...
## OpenBack v0.35.86 - Anchored 3D Battlefield
...
## OpenBack v0.35.85 - Stable 3D Terrain and Routes
...
## OpenBack v0.35.84 - Complete 3D Gameplay View
...
## OpenBack v0.35.83 - Complete OpenBack Store
...
## OpenBack v0.35.82 - Solid 3D Battlefield
...
## OpenBack v0.35.81 - Living 3D World
...
## OpenBack v0.35.80 - Expanded World Update
...
## OpenBack v0.35.79 - Social Request Alerts
...
## OpenBack v0.35.78 - Instant Social Parties and Team Play
...
## OpenBack v0.35.77 - Reliable Ranked Friend Parties
...
## OpenBack v0.35.76 - Restart-Safe Player Data
...
## OpenBack v0.35.75 - Ranked Friend Parties
...
## OpenBack v0.35.74 - Updated OpenBack Emblem
...
## OpenBack v0.35.73 - Player-Focused News
...
## OpenBack v0.35.67 - Stable Starts and Unified Pages
...
## OpenBack v0.35.66 - Consistent Legal Navigation
...
## OpenBack v0.35.65 - Reliable Page Switching
...
## OpenBack v0.35.64 - Focused Home and Legal Pages
...
## OpenBack v0.35.63 - Unobstructed Home Screen

- Removed the browser-performance warning banner from the home screen.

Created by **frootz jhklphy**.

## OpenBack v0.35.62 - Cleaner Main Navigation
...
## OpenBack v0.35.57 - Service Requests
...
## OpenBack v0.35.55 - Giant-Match Stability
...
## OpenBack v0.35.54 - Smoother Long Matches
...
## OpenBack v0.35.53 - Clearer Combat HUD and Living Disasters
...
## OpenBack v0.35.51 - Compact Player Board and Reliable Cosmetics
...
## OpenBack v0.35.49 - Minimum Ranked Win Gain
...
## OpenBack v0.35.48 - Fair Even-Match OB
...
## OpenBack v0.35.47 - High-Stakes OB Upsets
...
## OpenBack v0.35.46 - Nation-Count Reward Rules
...
## OpenBack v0.35.45 - Solo Match Rewards

- Added completion and victory cap rewards to qualifying Solo matches.

Created by **frootz jhklphy**.

## OpenBack v0.35.44 - OB Ranked Progression
...
## OpenBack v0.35.43 - Earnable Store Collection
...
## OpenBack v0.35.42 - Legal Navigation Tabs
...
## OpenBack v0.35.41 - Clear Browser Title

- Shortened the browser-tab title to OpenBack.

Created by **frootz jhklphy**.

## OpenBack v0.35.40 - Private Anonymous Profiles
...
## OpenBack v0.35.39 - Full-Tile Flags

- Made every flag fill its complete tile without an inset preview card.

Created by **frootz jhklphy**.

## OpenBack v0.35.38 - Claim Anonymous Profiles
...
## OpenBack v0.35.37 - Player-Chosen Teams
...
## OpenBack v0.35.36 - Compact Two-Row Unit HUD
...
## OpenBack v0.35.35 - Capturable Ready Vehicles
...
## OpenBack v0.35.34 - Unified Stacking Preview
...
## OpenBack v0.35.33 - Durable Player Accounts
...
## OpenBack v0.35.32 - Clear Hebrew Match Options
...
## OpenBack v0.35.31 - Social Team Matchmaking
...
## OpenBack v0.35.30 - Global Friends and Messaging
...
## OpenBack v0.35.29 - Long-Match Runtime Smoothing
...
## OpenBack v0.35.28 - Giant-Map Performance
...
## OpenBack v0.35.27 - In-App Friend Invitations
...
## OpenBack v0.35.26 - Long-Match Stability
...
## OpenBack v0.35.25 - Ranked Parties
...
## OpenBack v0.35.24 - Unlimited Naval Routes and Restored Starts
...
## OpenBack v0.35.23 - Frootz Maps and Global Naval Reach
...
## OpenBack v0.35.22 - Grand Earth and Reliable Starts
...
## OpenBack v0.35.21 - Integrated Learning and Clean Map Starts
...
## OpenBack v0.35.20 - Handcrafted Shattered Expanse
...
## OpenBack v0.35.19 - Continental Shattered Expanse
...
## OpenBack v0.35.18 - Fictional Worlds and Shattered Expanse
...
## OpenBack v0.35.17 - Saved Accounts and Public Profiles
...
## OpenBack v0.35.16 - Menu Logo Fix

- Restored the correct OpenBack wordmark and an undistorted B.

Created by **frootz jhklphy**.

## OpenBack v0.35.15 - Unified Identity
...
## OpenBack v0.35.14 - Cleaner Branding
...
## OpenBack v0.35.12 - Strategic World Mechanics
...
## OpenBack v0.35.11 - Large-Match Performance
...
## OpenBack v0.35.10 - Ranked Multiplayer
...
## OpenBack v0.35.9 - Military Logistics Trains
...
## OpenBack v0.35.8 - Vehicle Effects and Placement
...
## OpenBack v0.35.7 - Aircraft Beachheads and Destruction
...
## OpenBack v0.35.6 - Assault Balance and AI
...
## OpenBack v0.35.5 - Tanks, Bases, and Mines
...
## OpenBack v0.35.4 - Aircraft Refinement
...
## OpenBack v0.35.3 - Aircraft, Runways, and MANPADs
...
## OpenBack v0.35.2 - Accounts, Profiles, and Clans
...
## OpenBack v0.35.1 - Internet Multiplayer
...
## OpenBack v0.35.0 - First OpenBack Release
