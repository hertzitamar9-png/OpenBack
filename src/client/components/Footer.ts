      ...
      >
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            data-i18n-title="main.upstream_reddit"
            data-i18n-aria-label="main.upstream_reddit"
            class="opacity-60 hover:opacity-100 hover:scale-110 transition-all"
          >
            <svg
              class="h-6 w-6 lg:h-7 lg:w-7 object-contain pointer-events-none"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            data-i18n-title="main.upstream_discord"
            data-i18n-aria-label="main.upstream_discord"
            class="opacity-60 hover:opacity-100 hover:scale-110 transition-all"
          >
            <svg
              class="h-6 w-6 lg:h-7 lg:w-7 object-contain pointer-events-none"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            data-i18n-title="main.upstream_wiki"
            data-i18n-aria-label="main.upstream_wiki"
            class="opacity-60 hover:opacity-100 hover:scale-110 transition-all"
          >
            <img
