...
void main(){
  ...
  gl_Position=vec4(d.x/(viewZ*uTanHalfFov*uAspect),-viewY/(viewZ*uTanHalfFov),(viewZ/uDistance-1.0)*0.55-0.002,1.0);
  gl_PointSize=clamp((3.0+uRadius*.12)*(uDistance/viewZ),2.0,18.0);
