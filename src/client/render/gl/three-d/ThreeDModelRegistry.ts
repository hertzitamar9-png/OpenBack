...
export const THREE_D_MODELS: Readonly<Record<UnitType, ThreeDModelDefinition>> =
  {
    [UnitType.City]: {
      footprint: 2.8,
      primitives: [
        p("box", [-0.65, 0.65, 0], [0.8, 1.3, 0.9], "owner"),
        p("box", [0.35, 0.95, 0.2], [0.7, 1.9, 0.7], "owner"),
    ...
    [UnitType.DefensePost]: {
      footprint: 2.3,
      primitives: [
        p("cylinder", [0, 0.45, 0], [1.35, 0.9, 1.35], "owner"),
        p(
          "cylinder",
          [0, 1.0, 0],
          [0.7, 0.4, 0.7],
    ...
    [UnitType.SAMLauncher]: {
      footprint: 2.7,
      primitives: [
        p("box", [0, 0.3, 0], [2.1, 0.6, 1.5], "owner"),
        p(
          "box",
          [0, 1.0, 0],
          [1.35, 0.28, 0.85],
    ...
    [UnitType.Runway]: {
      footprint: 5.2,
      primitives: [
        p("box", [0, 0.08, 0], [5.0, 0.16, 1.35], "ground"),
    ...
    [UnitType.Tank]: {
      footprint: 2.6,
      primitives: [
        p("box", [0, 0.38, 0], [2.4, 0.65, 1.45], "owner"),
        p("box", [0, 0.75, 0], [1.25, 0.52, 1.05], "dark", undefined, "rotate"),
        p(
          "cylinder",
          [1.15, 0.92, 0],
          [0.15, 1.65, 0.15],
    ...
    [UnitType.Plane]: {
      ...
      animation: "bank",
      primitives: [
        p("cylinder", [0, 0.55, 0], [0.4, 2.8, 0.4], "owner", [
          0,
          0,
          -Math.PI / 2,
        ]),
    ...
    [UnitType.TransportShip]: {
      ...
      animation: "hover",
      primitives: [
        p("box", [0, 0.25, 0], [2.7, 0.45, 0.9], "owner"),
    ...
    [UnitType.Warship]: {
      ...
      animation: "hover",
      primitives: [
        p("box", [0, 0.3, 0], [3.1, 0.5, 1.05], "owner"),
    ...
    [UnitType.TradeShip]: {
      ...
      animation: "hover",
      primitives: [
        p("box", [0, 0.25, 0], [2.65, 0.45, 0.92], "owner"),
    ...
    [UnitType.Train]: {
      ...
      animation: "hover",
      primitives: [
        p("box", [0, 0.4, 0], [2.1, 0.75, 0.85], "owner"),
